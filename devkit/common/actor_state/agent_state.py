...
class AgentState(SceneObject):
    ...
    def __init__(
        ...
        :param velocity: Velocity (vectorial) of Agent. [vx,vy]  车辆几何中心的速度，纵向和横向速度分量。【 右手坐标系，x-纵向 向前为正，y-横向 向左为正】
        ...
        self._acceleration = acceleration  # 车辆几何中心的加速度，纵向和横向加速度分量。【 右手坐标系，x-纵向 向前为正，y-横向 向左为正】
