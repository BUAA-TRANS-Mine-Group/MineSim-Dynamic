...
from devkit.scenario_builder.scenario_filter import ScenarioFilter
...
class RepartitionStrategy(Enum):
    ...
    REPARTITION_FILE_DISK = 1  # Loading scenarios from JSON files, then redistribute to balance
