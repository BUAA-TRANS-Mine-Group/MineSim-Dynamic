...
from devkit.sim_engine.planning.planner.abstract_planner import PlannerReport
...
class RunnerReport:
    ...
    planner_report: Optional[PlannerReport]
    # Planner report containing stats about planner runtime, None if the runner didn't run a planner (eg. MetricRunner), or when a run fails
