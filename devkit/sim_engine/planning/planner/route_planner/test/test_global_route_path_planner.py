...
# {'shape': {'vehicle_type': 'MineTruck_XG90G', 'length': 9, 'width': 4, 'height': 3.5,
# 'min_turn_radius': 12, 'wheel_base': 5.15, 'locationPoint2Head': 6.5, 'locationPoint2Rear': 2.5},
...
route_planner = GlobalRoutePathPlanner(map_name=map_name, semantic_map=mine_map_api.semantic_map, minesim_graph=minesim_graph)
route_planner.get_ego_global_route_path(start_pose_statese2=StateSE2(x=1570.55, y=701.404, heading=6.01), goal_task=goal_task)
