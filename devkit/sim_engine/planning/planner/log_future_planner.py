...
from devkit.sim_engine.observation_manager.observation_type import DetectionsTrack, Observation
...
class LogFuturePlanner(AbstractPlanner):
    ...
    def compute_planner_trajectory(self, current_input: PlannerInput) -> AbstractTrajectory:
        ...
        try:
            ...
            logger.warning("#log# Cannot retrieve future ego trajectory. Using previous computed trajectory.")
