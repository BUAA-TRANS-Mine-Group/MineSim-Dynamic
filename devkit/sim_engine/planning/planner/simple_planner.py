...
from devkit.common.actor_state.ego_state import DynamicCarState, EgoState
...
from devkit.sim_engine.planning.planner.abstract_planner import AbstractPlanner, PlannerInitialization, PlannerInput
...
class SimplePlanner(AbstractPlanner):
    ...
    def __init__(
        ...
        self.vehicle = get_mine_truck_parameters(mine_name="guangdong_dapai")
        self.ego_update_model = KinematicBicycleModel(self.vehicle)
    ...
    def compute_planner_trajectory(self, current_input: PlannerInput) -> AbstractTrajectory:
        ...
        for _ in range(int(self.horizon_seconds.time_us / self.sampling_time.time_us)):
            ...
            state = self.ego_update_model.propagate_state(state, state.dynamic_car_state, self.sampling_time)
