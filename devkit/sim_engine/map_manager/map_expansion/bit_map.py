...
class BitMap:
    ...
    def load_bitmap_info(self):
        ...
        dir_semantic_map = os.path.join(self.dataroot, "maps", "semantic_map", semantic_map_hash + ".json")
        ...
        # self.UTM_local_x_range,self.UTM_local_y_range =self.bitmap_info['bitmap_mask_PNG']['canvas_edge_meter']
    ...
    def load_bitmap_using_utm_local_range(
        self, utm_local_range: Tuple[float, float, float, float] = (0.0, 0.0, 0.1, 0.1), x_margin=10, y_margin=10
    ) -> np.ndarray:
        """获取局部区域的像素矩阵.
