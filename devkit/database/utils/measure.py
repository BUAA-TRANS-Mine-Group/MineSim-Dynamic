...
from devkit.database.utils.boxes.box3d import Box3D
from devkit.database.utils.geometry import quaternion_yaw
...
def assign(box_list1: List[Any], box_list2: List[Any], dist_fcn: Callable[[Any, Any], float], assign_th: float) -> List[Tuple[Any, Any]]:
    """
